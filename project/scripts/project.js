...
const projects = [
    ...
    },
    {
        ...
        stack: 'C#',
        year: 2025,
        description: 'An ecommerce functionality that collects customer data and output orders (console).',
        repo: 'https://github.com/Emmaonukwue/cse210-hw/tree/main/week04/OnlineOrdering',
        live: '#',
    ...
    },
    {
        ...
        title: 'Scripture Memorizer App (C#)',
        stack: 'C#',
        year: 2025,
        description: 'Console app that gradually hides words to aid memorization, demonstrating encapsulation.',
        repo: 'https://github.com/Emmaonukwue/cse210-hw/tree/main/week03/ScriptureMemorizer',
        live: '#',
        imageAlt: 'Scripture Memorizer App',
        thumb: 'images/scripture-memorizer.webp'
    },
    {
        id: 'mdesign-admin',
        ...
        year: 2025,
        description: 'Custom admin UI with role-aware dashboard, and MySQL backend.',
        repo: 'https://emmaonukwue.github.io/project/',
        live: 'https://emmaonukwue.github.io/project/',
        imageAlt: 'School Report Admin Portal',
        thumb: 'images/school-portal.webp'
    }
];
